    ...
    public class Documentor
    {
        ...
        public static bool CreateDocumentation(string input, string output, string relativePath = null)
        {
            try
            {
                ...
                {
                    Core.Message += Environment.NewLine + "Unable to Parse " + input;
                    return false;
                }
            ...
            catch (Exception ex)
            {
                ...
                {
                    Core.Message += Environment.NewLine + "Documentor - Null Reference | " + string.Join(";",ex.Data.Values);
                ...
                {
                    Core.Message += Environment.NewLine + "Documentor - " + Core.CurrentObject.Name + " | " + ex.Message;
                }
                else
                {
                    Core.Message += Environment.NewLine + "Documentor - Null Reference | " + ex.Message;
                }
